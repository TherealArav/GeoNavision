...
2. For Streamlit Cloud Deployment: When you deploy your app, go to "Advanced settings..." and add your secrets. This is where you will set the password for the judges:
